...
#define GET_MULTISPHERE_SHAPE(wid, skid, bid, sid) dynamic_cast<dart::dynamics::MultiSphereConvexHullShape*>((Manager::skeleton(wid, skid)->getBodyNode(bid)->getShapeNodes()[sid])->getShape().get());
